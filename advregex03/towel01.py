...
mycomp22 = re.compile(r'ask|dark') # compiling mycomp as a reg ex
hikerexample = mycomp.findall(hitchhiker)
hikerexample22 = mycomp22.findall(hitchhiker)
...
print("The results of our stringexample2:", hikerexample22)
